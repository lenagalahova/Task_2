...
class TestCreateOrder:
    ...
    def test_create_order(self, stocks_api, registered_user):
    ...
    def test_create_order_invalid_ingredients(self, stocks_api, registered_user):
    ...
    def test_create_order_without_ingredients(self, stocks_api, registered_user):
        order_data = {}
        response_order = stocks_api.create_order(
            access_token=registered_user["accessToken"], json=order_data
        )
